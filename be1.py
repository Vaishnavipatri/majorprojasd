...
# Import or load Autism data using pandas
...
#encoding categorical attributes or columns
gender = {'m': 1,'f': 0}
...
plt.figure(figsize=(15,5))
sns.barplot(x='q6',y='HasAutism',data=df)
plt.title('Autism Spectrum Disorder vs Question 5')
plt.ylabel('Question 5')
plt.xlabel('Autism Spectrum Disorder')
plt.show()
...
plt.figure(figsize=(15,5))
sns.barplot(x='q7',y='HasAutism',data=df)
plt.title('Autism Spectrum Disorder vs Question 5')
plt.ylabel('Question 5')
plt.xlabel('Autism Spectrum Disorder')
plt.show()
...
plt.figure(figsize=(15,5))
sns.barplot(x='q8',y='HasAutism',data=df)
plt.title('Autism Spectrum Disorder vs Question 5')
plt.ylabel('Question 5')
plt.xlabel('Autism Spectrum Disorder')
plt.show()
...
#Evaluate accuracies of ML models
...
#loading or dumping best ML model into pickle file
import joblib
...
plt.ylabel('Prediction',fontsize=13)
plt.xlabel('Actual',fontsize=13)
plt.title('Confusion Matrix for KNN classifier',fontsize=17)
plt.show()
...
print("SVM roc curve:\n")
plt.figure()
plt.plot(fpr, tpr, color='darkorange', lw=2, label='ROC curve for SVM classifier (area = %0.2f)' % roc_auc)
...
# Plot the ROC curve
plt.figure()
plt.plot(fpr, tpr, color='darkorange', lw=2, label='ROC curve for Logistic Regression classifier (area = %0.2f)' % roc_auc)
plt.plot([0, 1], [0, 1], color='navy', lw=2, linestyle='--')
plt.xlim([0.0, 1.0])
plt.ylim([0.0, 1.05])
plt.xlabel('False Positive Rate')
...
# Plot the ROC curve
plt.figure()
plt.plot(fpr, tpr, color='darkorange', lw=2, label='ROC curve for Random forest classifier (area = %0.2f)' % roc_auc)
plt.plot([0, 1], [0, 1], color='navy', lw=2, linestyle='--')
plt.xlim([0.0, 1.0])
plt.ylim([0.0, 1.05])
plt.xlabel('False Positive Rate')
...
# Plot the ROC curve
plt.figure()
plt.plot(fpr, tpr, color='darkorange', lw=2, label='ROC curve for Decision tree classifier (area = %0.2f)' % roc_auc)
plt.plot([0, 1], [0, 1], color='navy', lw=2, linestyle='--')
plt.xlim([0.0, 1.0])
plt.ylim([0.0, 1.05])
plt.xlabel('False Positive Rate')
